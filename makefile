...
#	DIRS	+= $(RTOS_ROOT)/Source/portable/GCC/ARM_CM3_MPU	
	...
	DIRS	+= ../MyARMLib/STM32
	DIRS	+= ../MyARMLib/STM32/STM32F2xx/include
	DIRS	+= ../MyARMLib/STM32/STM32F2xx_StdPeriph_Driver/inc
	DIRS	+= ../MyARMLib/STM32/STM32F2xx_StdPeriph_Driver/src
	DIRS	+= ../MyARMLib/STM32/STM32F2x7_ETH_Driver/inc
#	DIRS	+= ../MyARMLib/HD44780
#	DIRS	+= ../MyARMLib/FreeRTOS
	DIRS 	+= ../MyARMLib/lwip/src/include
	DIRS	+= ../MyARMLib/lwip/src/include/ipv4
	DIRS 	+= ../MyARMLib/lwip/src/include/ipv6
	DIRS 	+= ../MyARMLib/lwip_port
	DIRS	+= ../MyARMLib/lwip/src/include/lwip
